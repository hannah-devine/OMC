{
    ...
    const handleSubmitForm = e => {
        ...
        render3DScene(fullName);
    };

    const render3DScene = (fullName) => {
        ...
        fontLoader.load('https://threejs.org/examples/fonts/helvetiker_bold.typeface.json', function (font) {
            ...
            //  Adds the name mesh to the scene
    ...
    const createTypo = (fullNameMesh, font) => {
        const word = fullNameMesh;
        console.log(word);
        ...
        const createText = new THREE.TextGeometry(fi, typoProperties);
        textMesh.geometry = createText;
