...

{
  ...
  new THREE.CylinderBufferGeometry(8, 8, 30, 62), new THREE.DodecahedronBufferGeometry(10, 10),
  new THREE.CircleGeometry(10, 10), new THREE.TetrahedronBufferGeometry(15, 15),
  new THREE.TorusBufferGeometry(10, 3, 16, 100), new THREE.OctahedronBufferGeometry(10, 10), new THREE.IcosahedronBufferGeometry(8, 8), new THREE.SphereBufferGeometry(10, 150, 32)];
  ...
  const handleSubmitForm = e => {
    ...
    const distUser = $form.querySelector(`.dist`).value;
